package com.nakul.ecommerce.eweb_backend.api.controller.user;

import com.nakul.ecommerce.eweb_backend.entities.Address;
import com.nakul.ecommerce.eweb_backend.entities.LocalUser;
import com.nakul.ecommerce.eweb_backend.entities.dao.AddressDAO;
import com.nakul.ecommerce.eweb_backend.service.UserService;
...
/**
 * Rest Con     <troller for user data interactions.
 */
@RestController
@RequestMapping("/user")
public class UserController {
    ...
    public ResponseEntity<Address> putAddress(
        ...
        //simpMessagingTemplate.convertAndSend("/topic/user/" + userId + "/address",
          ///      new DataChange<>(DataCh>>ange.ChangeType.INSERT, address));
